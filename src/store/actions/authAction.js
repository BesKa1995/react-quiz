...
export function auth(email, password, isLogin) {
  return async dispatch => {
    ...
    let url = 'https://identitytoolkit.googleapis.com/v1/accounts:signUp?key=AIzaSyCo7NSWuLPmZF8oVpE1n8GFrqttTrp_M4U'
    if (isLogin) {
      url = 'https://identitytoolkit.googleapis.com/v1/accounts:signInWithPassword?key=AIzaSyCo7NSWuLPmZF8oVpE1n8GFrqttTrp_M4U'
    }
